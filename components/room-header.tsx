...
import { Radio, Users, QrCode } from 'lucide-react'
          ...
          <div className="flex items-center gap-2">
            {meetingId && (
              <button
                ...
                className="flex items-center gap-1.5 rounded-full border border-indigo-500/30 bg-indigo-600/10 hover:bg-indigo-600/20 px-3 py-2 text-xs font-semibold text-indigo-400 transition"
                title="Share QR Code"
              >
